...
var newsData = [
  ...
  { id: "t3", title: "Temu加速欧洲本地化：建立本地仓储网络应对欧盟关税新政", content: "面对欧盟即将实施的关税新政，Temu在多个欧洲国家建立本地仓储，将部分商品从跨境直邮转为本地发货，以规避关税并缩短配送时间。", source: "Lengow", type: "press", platform: "temu", dimension: "logistics", date: new Date("2025-12-30"), url: "https://blog.lengow.com/temus-localization-strategy-in-europe/" },
  { id: "a7", title: "AliExpress与Temu同属中国跨境电商阵营，面临内部流量竞争压力", content: "AliExpress（阿里系）与Temu（拼多多系）在欧美市场形成直接竞争。两者均依赖中国供应链和低价策略，在关税政策收紧背景下面临相似挑战，同时争夺同一批卖家和消费者。", source: "European Conservative", type: "press", platform: "aliexpress", dimension: "traffic", date: new Date("2025-12-01"), url: "https://europeanconservative.com/articles/news/eu-tariffs-shein-temu-aliexpress-china-dumping-safety-competition/" },
  { id: "a2", title: "AliExpress Choice采用全托管模式，结合菜鸟物流实现订单量同比增长60%", content: "AliExpress Choice定位为全托管服务，结合阿里巴巴集团物流能力（菜鸟网络），为卖家简化运营流程，为消费者提供优选商品和快速配送。该模式推动订单量同比增长60%。", source: "Alibaba Group / PR Newswire", type: "press", platform: "aliexpress", dimension: "seller", date: new Date("2024-02-08"), url: "https://www.alibabagroup.com/document-1696296090350911488" }
];
// 初始化时间显示
